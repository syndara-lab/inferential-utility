...
class CTGAN():
    ...
    def __init__(self, embedding_dim=128, generator_dim=(256, 256), discriminator_dim=(256, 256),
                 discriminator_dropout=0.5, generator_dropout=0, # NEW: discriminator_dropout and generator_dropout
    ...
    def fit(self, train_data, discrete_columns=(), epochs=None, eval_epochs=[], scoring_method=None, val_data=None, seed=2024):
        ...
        # NEW: set manual seed for reproducibility
    ...
    def sample(self, n, condition_column=None, condition_value=None, seed=2024):
        ...
        Args:
            ...
            (NEW!) seed (int): 
                Manual seed for model sampling.
